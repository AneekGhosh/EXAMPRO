...
public class AdminController {
    ...
    @Transactional(readOnly = true) // Prevents LazyInitializationException when getting sizes of child collections
    public String adminDashboard(Model model) {
        ...
        model.addAttribute("recentSubmissions", recentResults);
    ...
    public String deleteExam(@PathVariable Long examId) {
        // CascadeType.ALL, deleting the exam will also delete all associated questions and results.
    ...
    // Restored this method (it was accidentally deleted)
    ...
    // Kept only ONE copy of this method mapping to /student/manage
    ...
    public String deleteStudent(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        try {
            ...
            // MANUALLY delete the "children" (ExamResults)
            examResultRepository.deleteByStudent(student);
            examResultRepository.flush();

            // NOW it is safe to delete the "parent" (User)
        ...
        // Fixed redirect URL
        return "redirect:/admin/student/manage";
    }
    ...
    public String resetStudentPassword(@RequestParam("userId") Long userId,
        ...
        if (newPassword.isEmpty()) {
            ...
            return "redirect:/admin/student/manage"; // Fixed redirect URL
        }
